    ...
    <form action="./php/cadastrar-pet.php" id="cadastroPet" method="POST">
        <div id="passo">
            <div id="passo-1" class="div-cadastro passo-ativo">
                ...
                <div class="div-cadastro-opcao" >
                    <button type="button" class="botao-pet" onclick="selecionarPet(this, 'gato')">
                ...
                <div class="div-cadastro-opcao">
                    <button type="button" class="botao-pet" onclick="selecionarPet(this, 'coelho')">
                ...
                <div class="div-cadastro-opcao">
                    <button type="button" class="botao-pet" onclick="selecionarPet(this, 'roedor')">
            ...
            <div id="passo-6" class="div-cadastro depois">
                <div class="div-cadastro-titulo">
                    ...
                    <p onclick="show_hide()" class="button-default">Venda</p>
                    <button class="button-default">Adoção</button>
                    <button class="button-default">NamoroPet</button>
                </div>
                <div class="div-cadastro-opcao">
